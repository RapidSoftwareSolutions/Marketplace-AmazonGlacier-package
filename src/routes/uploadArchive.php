...
$app->post('/api/AmazonGlacier/uploadArchive', function ($request, $response, $args) {

    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'region', 'vaultName','sourceFile']);
    ...
    try {
        $res = $client->uploadArchive($body)->toArray();
