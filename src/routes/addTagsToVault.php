...
$app->post('/api/AmazonGlacier/addTagsToVault', function ($request, $response, $args) {

    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'region', 'vaultName','tags']);
    ...
    try {
        $res = $client->addTagsToVault($body)->toArray();
