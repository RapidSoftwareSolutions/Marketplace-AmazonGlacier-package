...
$app->post('/api/AmazonGlacier/deleteVaultTags', function ($request, $response, $args) {

    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'region', 'vaultName', 'tagKeys']);
    ...
    try {
        $res = $client->removeTagsFromVault($body)->toArray();
