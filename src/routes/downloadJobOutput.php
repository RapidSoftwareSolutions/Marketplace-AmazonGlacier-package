...
$app->post('/api/AmazonGlacier/downloadJobOutput', function ($request, $response, $args) {

    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'region', 'vaultName','jobId']);
    ...
    $body['jobId'] = $post_data['args']['jobId'];
    ...
    try {
        $res = $client->getJobOutput($body)->toArray();
