...
$app->post('/api/AmazonGlacier/completeMultipartUpload', function ($request, $response, $args) {

    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'region', 'vaultName','uploadId','archiveSize','checksum']);
    ...
    $body['archiveSize'] = $post_data['args']['archiveSize'];
    ...
    try {
        $res = $client->completeMultipartUpload($body)->toArray();
