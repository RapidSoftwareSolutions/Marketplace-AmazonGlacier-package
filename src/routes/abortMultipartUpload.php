...
$app->post('/api/AmazonGlacier/abortMultipartUpload', function ($request, $response, $args) {

    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'region', 'vaultName','uploadId']);
    ...
    try {
        $res = $client->abortMultipartUpload($body)->toArray();
