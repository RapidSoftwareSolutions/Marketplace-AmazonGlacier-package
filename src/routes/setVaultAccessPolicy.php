...
$app->post('/api/AmazonGlacier/setVaultAccessPolicy', function ($request, $response, $args) {
    ...
    if (!empty($post_data['args']['policy'])) {
    ...
    try {
        $res = $client->setVaultAccessPolicy($body)->toArray();
